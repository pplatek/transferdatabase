...
public class TransferDatabaseResultSet implements ResultSet {
    private TransferDatabaseStatement statement;
    private ResultSet resultSet;

    public TransferDatabaseResultSet(TransferDatabaseStatement statement, ResultSet resultSet) {
